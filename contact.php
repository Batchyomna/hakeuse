...
$adresse=f_desaccentuation_EU($_POST['Prenom']);
$email=$_POST['email'];
...
$corps .= '<p>Votre avis: <strong>'.$chantier.'</strong></p>';
...
$destinataire ='kh.yomn@gmail.com';
$mail->AddAddress($destinataire, '');
//-----------------------------------------------------------------------------

$mail->Subject    = 'Contact depuis notre site '.$objet;
